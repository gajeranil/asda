    ...
    return(
        ...
        <div className="signup-main-section flex   bg-cover bg-top bg-no-repeat" >
            ...
            <div className="mb-20 mr-16">
                ...
                <form className="" >
                    <h3 className="text-2xl font-bold text-slate-800 mb-5">Reset Password?</h3>
                    
                    <div className="relative mb-7">
                    <label className="absolute -top-2 right-[62%] bg-white px-2 w-28 text-gray-600 text-sm">New Password</label>
                        <input type="password" placeholder="anniemario" className="border w-[370px] px-9 py-4 text-sm rounded-md"></input>
                    </div>
                    <div className="relative mb-7">
                    <label className="absolute -top-2 right-[58%] bg-white px-2 w-32 text-gray-600 text-sm">Confirm Password</label>
                        <input type="password" placeholder="anniemario" className="border w-[370px] px-9 py-4 text-sm rounded-md"></input>
                    </div>
                    <a href="#" className="px-9 text-white font-bold relative rounded-md py-5 mt-7 leading-[60px] bg-blue-600 before:content-[''] before:absolute before:w-[200px] before:h-[62px] before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-blue-600 before:-z-10 before:hover:scale-110 before:duration-300 before:rounded-md">Reset Password</a>
                </form>
            </div>
